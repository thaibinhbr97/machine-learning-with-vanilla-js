class Chart {
   ...
   #getDataBounds() {
      ...
      const bounds = {
         left: minX,
         right: maxX, // use this for squeezing the data
         top: maxY, // use this for squeezing the data
         // right: minX + maxDelta, // use this for the normalization on the data
         // top: minY + maxDelta, // use this for the normalization on the data
         bottom: minY
      };
      return bounds;
   }
   ...
   #draw() {
      ...
      // command out to hide image data (START)
      ...
      // command out to hide image data (END)
